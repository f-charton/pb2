...
def get_parser():
    ...
    parser.add_argument('--sampling_method', type=str, default="top", help="sampling method: you can choose between top, pow, exp")
    parser.add_argument('--sampling_pow_score', type=float, default=1.0, help="power score for sampling: if sampling_method is pow, this is the power")
