...
def get_parser():
    ...
    parser.add_argument('--sampling_method', type=str, default="top", help="sampling method: you can choose between top, power, exp")
    parser.add_argument('--sampling_pow_score', type=float, default=1.0, help="power score for sampling: if sampling_method is power, this is the power")
    parser.add_argument('--sampling_exp_score', type=float, default=1.0, help="exp score for sampling: if sampling_method is exp, this is the multiplier for the exp")
